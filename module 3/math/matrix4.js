...
var Matrix4 = function(x, y, z) {
	...
	this.setRotationX = function(degrees) {
		...
		// DONE - set every element of this matrix to be a rotation around the x-axis
		e[0] = 1;
		e[1] = 0;
		e[2] = 0;
		e[3] = 0;
	...
	this.setRotationY = function(degrees) {
		...
		// DONE - set every element of this matrix to be a rotation around the y-axis
	...
	this.setTranslation = function(arg1, arg2, arg3) {
		// DONE - wipe out the existing matrix and make it a pure translation
		//      - If arg1 is a Vector3, use its components and ignore arg2 and arg3
		//      - Otherwise, treat arg1 as x, arg2 as y, and arg3 as z
		// Replace all values
	...
	this.setRotationZ = function(degrees) {
		...
		// DONE - set every element of this matrix to be a rotation around the z-axis
		e[0] = Math.cos(radians);
	...
	this.setPerspective = function(fovy, aspect, near, far) {
		// DONE - convert fovy to radians
		// var fovyRads = ...
		let fovyRads = fovy * (Math.PI/180);

		// DONE -compute t (top) and r (right)
		// n/r = 1 / (aspect * tan(fovy/2))
		let e00 = 1 / (aspect * Math.tan(fovyRads/2));
		// n/t = 1 / tan(fovy/2)
		let e11 = 1 / Math.tan(fovyRads/2);
		let e22 = -1 * ((far + near) / (far - near));
		let e23 = -1 * ((2 * near * far) / (far - near));
		let e32 = -1;

		// shortcut - use in place of this.elements
		var e = this.elements;

		// DONE - set every element to the appropriate value
		e[0] = e00;
		e[1] = 0;
		e[2] = 0;
		e[3] = 0;
	...
	this.translate = function(arg1, arg2, arg3) {
		// DONE - add a translation to the existing matrix
		//      - If arg1 is a Vector3, add its components and ignore arg2 and arg3
		//      - Other wise., treat arg1 as x, arg2 as y, and arg3 as z
