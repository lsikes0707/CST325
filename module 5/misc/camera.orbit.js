// AUTHOR: JOHN SEALS AND LACEY SIKES
function OrbitCamera(input) {
    ...
    this.getViewMatrix = function() {
        // DONE return the correct view matrix (you will need to use "clone")
    ...
    this.getPosition = function() {
		...
		return new Vector3(this.cameraWorldMatrix.clone().getElement(0,3),this.cameraWorldMatrix.clone().getElement(1,3),this.cameraWorldMatrix.clone().getElement(2,3));
